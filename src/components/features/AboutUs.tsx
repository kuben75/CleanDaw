            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        >
                            Znamy się na <span className="text-blue-500">brudnej robocie</span>
                        </h2>

                        <p className="text-lg text-zinc-300 mb-6 leading-relaxed">
                            Nie opowiadamy bajek o magii. Jesteśmy rzemieślnikami, którzy na co dzień mierzą się z najtrudniejszymi zabrudzeniami tapicerki samochodowej i meblowej. Zamiast pustych obietnic, dostarczamy konkretne rezultaty – materiał wyprany, odplamiony i gotowy do użytku.
                        </p>

                        <div className={`grid transition-all duration-500 ease-in-out ${isExpanded ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
                            <div className="overflow-hidden">
                                <p className="text-lg text-zinc-400 pb-6 leading-relaxed">
                                    Nasza praca wymaga odpowiedniego arsenału. Korzystamy z potężnych odkurzaczy ekstrakcyjnych, które płuczą materiał pod ciśnieniem, fizycznie wyciągając brud, z którym domowe sposoby nie mają szans. Nie maskujemy tanimi zapachami – usuwamy źródło problemu, zachowując pełne bezpieczeństwo samej tapicerki.
                                </p>
                            </div>
                        </div>
